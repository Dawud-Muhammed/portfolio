...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $defaults = [
            ...
            'nav_about_url' => route('home.about'),
            'nav_skills_url' => route('home.skills'),
            'nav_projects_url' => route('projects.index'),
            'nav_testimonials_url' => route('home.testimonials'),
            'nav_contact_url' => route('home.contact'),
            'contact_name_label' => 'Name',
            'contact_email_label' => 'Email',
            'contact_subject_label' => 'Subject',
            'contact_message_label' => 'Message',
            'footer_home_label' => 'Home',
            'footer_copyright_name' => 'Dawud Muhammed',
