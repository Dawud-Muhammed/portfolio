    ...
    <main class="mx-auto w-full max-w-7xl px-6 pb-20 pt-10" aria-labelledby="blog-title">
        <section class="space-y-8">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1.45fr_0.95fr] lg:items-end">
                ...
                <div class="overflow-hidden rounded-3xl border border-slate-200/80 bg-white/80 shadow-premium backdrop-blur-sm">
                    <div class="flex flex-col gap-4 p-5 sm:flex-row sm:items-center">
                        ...
                        <div class="min-w-0">
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-orange-600">Author profile</p>
                            <h2 class="mt-2 text-xl font-semibold tracking-tight text-slate-900" style="font-family: var(--font-display);">
                                {{ $heroName }}
                            </h2>
                            <p class="mt-1 text-sm font-medium text-slate-600">{{ $heroTitle }}</p>
                        </div>
                    </div>
                </div>
            </div>
